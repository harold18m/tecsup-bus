            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="p-4 border rounded-md hover:border-tecsup-light/50 transition-colors">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        <MapPin className="h-3 w-3 text-gray-400 mr-1" />
                        <p className="text-sm text-gray-500">Downtown Terminal → Tecsup Campus</p>
                      </div>
                    </div>
                    <Button size="sm" className="bg-tecsup hover:bg-tecsup-dark text-white">
                      Book
                ...
                <div className="p-4 border rounded-md hover:border-tecsup-light/50 transition-colors">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="font-medium">Campus to North Terminal</h4>
                      <div className="flex items-center mt-1">
                        <MapPin className="h-3 w-3 text-gray-400 mr-1" />
                        <p className="text-sm text-gray-500">Tecsup Campus → North Terminal</p>
                      </div>
                    </div>
                    <Button size="sm" className="bg-tecsup hover:bg-tecsup-dark text-white">
                      Book
